...
export const fetchCourseCategories = async () => {
  try {
    ...
    return response.data.allCategory   // 👈 directly return categories
  } catch (error) {
    console.log(
...
export const createSection = async (data, token) => {
  ...
  try {
    ...
    console.log("details 3444",response?.data?.updatedCourseDetails?.courseContent);
    result = response?.data?.updatedCourseDetails?.courseContent
  } catch (error) {
